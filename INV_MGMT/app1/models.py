...
class Sold(models.Model):
    ...
    slitting_price = models.IntegerField(default=0)
    pleating_price = models.IntegerField(default=0)
    packing_charges = models.IntegerField(default=0)
    cgst = models.IntegerField(editable=True, default=0)
    sgst = models.IntegerField(editable=True, default=0)
    igst = models.IntegerField(editable=True, default=0)
...
class Proforma_Invoice(models.Model):
    PID = models.IntegerField(null=False, editable=True, default=0)
    PIDsold = models.BooleanField(default=False)
    customer_name = models.ForeignKey(customer, on_delete=models.CASCADE)
    item_req = models.ForeignKey(stock, on_delete=models.CASCADE)
    req_date =  models.DateField(editable=True) #datetime.date(2022, 9, 11)
    sell_price = models.IntegerField(editable=True,default=0)
    slitting_price = models.IntegerField(default=0)
    pleating_price = models.IntegerField(default=0)
    total_non_tax_price = models.IntegerField(editable=True, default=0)
    packing_charges = models.IntegerField(default=0)
    cgst = models.IntegerField(editable=True, default=0)
    sgst = models.IntegerField(editable=True, default=0)
    igst = models.IntegerField(editable=True, default=0)
